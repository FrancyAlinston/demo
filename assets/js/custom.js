jQuery(document).on('click', 'a.display-staff', function(){
    var neftaccountclosed_id = jQuery(this).data('neftaccountclosedID');
    jQuery.ajax({
        type:'POST',
        url:baseurl+'staff/display',
        data:{neftaccountclosed_id: neftaccountclosed_id},
        dataType:'html',
        beforeSend: function () {
...
jQuery(document).on('click', 'a.delete-staff-details', function(){
    var neftaccountclosed_id = jQuery(this).attr('data-neftaccountclosedID');
	$('#delete-staff').on('shown.bs.modal', function (event) {
	  jQuery('#neftaccountclosed_id').val(neftaccountclosed_id);
	});
});
jQuery(document).on('click', 'button#delete-staff', function(){
    var neftaccountclosed_id = jQuery('#neftaccountclosed_id').val();
    jQuery.ajax({
        type:'POST',

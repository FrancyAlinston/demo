...
<section class="content-header" id="filterHead">
	<h1>Import Beneficary TrialBalance File [tally export excel]</h1>
	<?php include '_breadcrumbs.php'; ?>
	<div class="box box-info" style="margin-top: 5px; background: #a0e0ed;">
		<div class="box-body w3-allerta">
			<div class="row">
				<div class="col-md-6">
					<form autocomplete="off" enctype="multipart/form-data" action="" name="frmExel" id="frmExel"
						method="post">
						<div class="form-group">
							...
							<input type="file" style="display: none;"
								onchange="fileUploadBinary('exlBenTrial','frmExel')" name="urlM" id="urlM"
								class="form-control">
							<input type="hidden" name="txtexlBenTrial" id="txtexlBenTrial" value="">
						</div>
					</form>
				</div>
			</div>

...
<section class="content">
	...
	<form method="post" onsubmit="return calculateIncentive()" id="frmAccountsIncentive" name="frmAccountsIncentive">
						...
						<div class="row">
							...
							<div class="col-md-2">
								 <button class="btn btn-primary center-block" style="margin-top:25px" >Calculate Transactions</button>
							 </div>
						</div>

...
<section class="content-header" id="filterHead">
	<h1>Cadidates Selected For Interview </h1>
				...
				<div class="col-md-8">
					<div class="row">
						...
						<div class="col-md-4">
					        ...
					        <div class="btn btn-md btn-primary" onclick="innterviewCandidates()">View Candidates</div>
					        <i onclick="exportInterviewCandidates()" title="Export to excel" aria-hidden="true" class="fa fa-file-excel-o" style="float: right;color: #00A65A; font-size: 34px; cursor: pointer;"></i>
						</div>
					</div>
	...
	<div class="box box-danger" style="background-color: #f6b6bf;">
			<div class="box-body w3-allerta">
				<div class="row">
					<div class="col-md-4">
					...
					<div class="col-md-4">
						<label for="txtBatch"> &nbsp;</label><br>
						<div onclick="promoteToStudent()" class="btn btn-success">Promote to Student</div>
					</div>
					<div class="col-md-4">
					</div>
				</div>

...
<section class="content">
    <div class="container w3-allerta">
      ...
      <div class="row">
        ...
        <div class="">
            <table id="staffListing" class="table table-bordered table-hover small" style="background: #a0e1a4;">>
                <thead>
                    <tr>
                        <th scope="col">#</th>
    ...
    jQuery(document).ready(function () {
        jQuery('#staffListing').dataTable({
            ...
            "ajax": {
                ...
                "type": "POST",
                "data": function ( data ) {
                    data.nes_id = $('#name_filter').val();
                    data.acnumber = $('#email_filter').val();
                    data.ifsc = $('#contact_filter').val();
                    data.branchid = $('#address_filter').val();
                }
            },

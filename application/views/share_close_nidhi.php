			...
			<div class="box-body">
				<form method="post" onsubmit="return advancedSearch('closing')" id="frmBenAdvanceSearch" name="frmBenAdvanceSearch">
						...
						<div class="row">
	                        ...
	                        <div class="col-md-4">
								<div class="form-group">
									<label for="txtShareCertificateId">Share Certificate</label>
									<input id="txtShareCertificateId" name="txtShareCertificateId" class="form-control" value="" type="text" onkeyup="advancedSearch('closing')">
								</div>
							</div>
						</div>
				<hr>

...
<section class="content">
	<form method="post" onsubmit="return validateBen()" id="frmAddBeneficiary">
		<div class="row">
			<!-- left column -->
			<div class="col-md-12">
				...
				<div class="box box-primary" style="background: #85b6f7;">
					<div class="box-header with-border" >
						...
						<div class="form-group" style="float:right;margin:0px">
							<input type="text" placeholder="Beneficiary ID Override" id="txtBenIDOver" name="txtBenIDOver" class="form-control">
							<small>six digit number, add preceding zeros if not 6 digits, eg: 028127</small>
						</div>
					</div>
					<!-- /.box-header -->
				...
				<div class="box box-warning" style="background: #dddca7;">
					<div class="box-header with-border">
				...
				<div class="box box-warning" style="background: #e9d6b8;">
					<div class="box-header with-border">

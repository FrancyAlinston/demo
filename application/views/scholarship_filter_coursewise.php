...
include '_header.php';
?>
<section class="content-header" id="filterHead" style="padding-bottom: 10px;">
	<h1>Application List, Filter &amp; Export </h1>
	<?php include '_breadcrumbs.php'; ?>
	<div class="box box-info" style="margin-top: 5px; background: #dfdccb;">
		<div class="box-body w3-allerta">
			<div class="row">
				<div class="col-md-3">
					<div class="form-group">
						<label for="txtYear">Select Batch</label>
						<select id="txtYear" name="txtYear" class="form-control selectpicker" data-live-search="true" onchange="getScholarshipFilterCourseWise()">
							<option value=""></option>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<select id="txtCourse" name="txtCourse" class="form-control" onchange="getScholarshipFilterCourseWise()" required>
				...
				<div class="col-md-3">
					<div class="form-group">
						<i onclick="exportScholarshipCoursewise()" title="Export to excel" aria-hidden="true" class="fa fa-file-excel-o" style="float: right;color: #00A65A; font-size: 20px; cursor: pointer;"></i>
						<label for="selEduFrm">Select Education Forum</label>
						<select id="selEduFrm" name="selEduFrm" class="form-control" onchange="getScholarshipFilterCourseWise()">
							<option value="">All</option>
